...
// some sounds
const hitSound = new Audio('../sound/sounds_hitSound.wav');
const scoreSound = new Audio('../sound/sounds_scoreSound.wav');
const wallHitSound = new Audio('../sound/sounds_wallHitSound.wav');
